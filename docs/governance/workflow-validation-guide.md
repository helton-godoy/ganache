...
* **🔎 Validation Check:**
  * [ ] **Safety Commit:** Did the agent commit the research file *immediately* upon creation?
...
* **🔎 Validation Check:**
  ...
  * [ ] **Commit Gate:** Did the PM perform a `git commit` ("feat: update PRD for X") *before* handing off?
...
* **🔎 Validation Check:**
  ...
  * [ ] **Safety Commit:** Was the architecture committed *before* Epics were generated?
...
* **🔎 Validation Check:**
  ...
  * [ ] **Atomic State:** Was the YAML committed *immediately*? (This implies the "Green Light" for Dev).
...
* **🔎 Validation Check (The "Audit"):**
  * [ ] **Partial Commits:** Are there commits for *each* subtask, or did the agent dump one giant commit at the end? (One giant commit = **FAIL**).
  * [ ] **Comment Quality:** Do comments explain *WHY* and link to the Story?
