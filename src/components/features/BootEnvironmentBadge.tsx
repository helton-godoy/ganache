                    ...
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Badge variant="outline" className="gap-2 bg-emerald-50 text-emerald-700 border-emerald-200 cursor-pointer hover:bg-emerald-100 transition-colors">
                            ...
                            <TooltipContent>
                                <div className="space-y-1">
                                    <p className="font-semibold text-sm">Active Boot Environment</p>
                                    <div className="text-xs text-muted-foreground flex flex-col gap-0.5">
                                        ...
                                        <span className="text-emerald-600 font-medium mt-1">Click to Manage</span>
                                    </div>
                                </div>
                            </TooltipContent>
                        </Tooltip>
