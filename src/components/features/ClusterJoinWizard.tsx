    ...
    return (
        <Card className="w-full max-w-4xl mx-auto border-none shadow-none bg-transparent">
            <CardHeader className="text-center">
                <CardTitle className="text-3xl font-extrabold tracking-tight">Twin-Node Cluster Setup</CardTitle>
                <CardDescription className="text-lg">
                    Initialize the high-availability link between your primary and secondary nodes.
                </CardDescription>
            </CardHeader>
            <CardContent>
                {step === 1 && (
                    <div className="space-y-6 max-w-md mx-auto pt-8">
                        <div className="space-y-2">
                            <label className="text-sm font-medium leading-none">Secondary Node IP Address</label>
                            <Input
                            ...
                            <p className="text-xs text-muted-foreground">
                                Ensure the secondary node is powered on and accessible via the management network.
                            </p>
                        </div>
                        <Button
                        ...
                        >
                            {joinMutation.isPending ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : <ArrowRight className="mr-2 h-5 w-5" />}
