      ...
      <div className="flex items-center justify-between w-full max-w-2xl relative">
        ...
        >
          ...
          <div className="text-center">
            ...
            <Badge
              variant={
                isReady ? "default" : isFailover ? "destructive" : "secondary"
              }
            >
      ...
      <div className="text-center space-y-2 max-w-md w-full">
        ...
        {isReady && (
          <p className="text-emerald-500 font-bold flex items-center justify-center gap-2">
            <ShieldCheck className="w-5 h-5" /> HA LINK ACTIVE
          </p>
        )}
        {isConfiguring && (
        ...
        {isFailover && (
          <p className="text-orange-500 font-bold flex items-center justify-center gap-2 animate-pulse">
            <AlertTriangle className="w-5 h-5" /> FAILOVER IN PROGRESS
          </p>
        )}
      </div>
    </div>
