                ...
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        <p className="text-sm text-muted-foreground">
                            This will apply ACL changes to all files and subdirectories under <code className="text-xs bg-muted px-1 rounded">{path}</code>.
                        </p>
                        <p className="text-sm text-amber-600 mt-2">
                            ⚠️ <strong>Note:</strong> For directories with many files, this operation may take several seconds to minutes.
                            The operation runs synchronously and cannot be canceled once started.
                        </p>
