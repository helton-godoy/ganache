        ...
        mutation: {
            ...
            onError: (error: any) => {
                toast({
                    ...
                    description: error.response?.data || error.message || 'Failed to rollback configuration',
                    variant: 'destructive',
                });
            },
        },
                ...
                <div className="space-y-4 py-4">
                    <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-4 space-y-2">
                        <div className="flex justify-between items-start">
                            <div>
                                <h4 className="font-semibold text-sm text-slate-300">Target Commit</h4>
                                <p className="text-xs text-slate-500 mt-1">Created by {commit.author}</p>
                            </div>
                        ...
                        <p className="text-xs text-slate-500">{new Date(commit.date).toLocaleString()}</p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-slate-500">
                            This will be logged in the audit trail for compliance and troubleshooting
                        </p>
                    </div>
                </div>
