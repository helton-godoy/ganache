...
interface AuditSearchProps {
    onSearch: (filename: string, user?: string, dateFrom?: string, dateTo?: string) => void;
 ...
 */
export const AuditSearch: React.FC<AuditSearchProps> = ({ onSearch, results, isLoading }) => {
    ...
    const handleSearch = (e: React.FormEvent) => {
        e.preventDefault();
        onSearch(filename, user || undefined, dateFrom || undefined, dateTo || undefined);
    };
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {results.map((event) => (
                                    <tr key={event.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-500 max-w-xs truncate" title={event.resource || 'N/A'}>
                                            {event.resource || 'N/A'}
                                        </td>
                                    </tr>
                                ))}
