            ...
            {hardwareInfo?.data?.has_raid && (
              <div className="bg-blue-50 text-blue-700 text-xs p-3 rounded-md border border-blue-100 mt-4 animate-in slide-in-from-top-2 duration-500">
                <div className="flex items-center gap-2 font-bold mb-1">
                  ...
                  Hardware Detected:{" "}
                  {hardwareInfo.data.controller_name || "RAID Controller"}
                </div>
                <p>
                  Compatibility mode ensures ZFS runs safely on top of your
                  existing virtual drives without data corruption risks.
                </p>
              </div>
            )}
          </CardContent>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <br />
              <br />
              Using <strong>Standard Mode</strong> (ZFS) on top of hardware RAID
              can lead to reliability issues and is{" "}
              <strong>not recommended</strong> unless you have flashed your
              controller to IT Mode.
              <br />
              <br />
