...
test.describe('Security API Expansion (Story 5.4 - P1/P2)', () => {
    ...
    test('[P1] GET /api/v1/security/events - should filter events by IP', async ({ request }) => {
    ...
    test('[P1] GET /api/v1/security/events - should filter events by user', async ({ request }) => {
    ...
    test('[P1] OpenAPI Sync: Should match SecurityEvent model schema', async ({ request }) => {
    ...
    test('[P2] GET /api/v1/security/events - should handle invalid date range with 400', async ({ request }) => {
